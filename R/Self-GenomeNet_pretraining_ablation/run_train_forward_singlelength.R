source("R/Self-GenomeNet_pretraining_ablation/train_Self_GenomeNet_forward_singlelength.R")
...
source("R/Self-GenomeNet_pretraining_ablation/loss_function_forward_singlelength.R")
