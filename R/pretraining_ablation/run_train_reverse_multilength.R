source("R/pretraining_ablation/train_Self_GenomeNet_reverse.R")
...
train_Self_GenomeNet_reverse_multilength(
  ...
  steps_per_epoch = 400,
  learningrate    = 0.0001,
  run_name        = paste("Self-GenomeNet_reverse_multi", format(Sys.time(), "_%y%m%d_%H%M"), sep = ""),
